...
public class BlogController {
    private static final String INPUT="admin/biogs-input";
    private static final String LIST="admin/biogs";
    ...
    @GetMapping("/blogs")
    public String blogs(@PageableDefault(size = 2,sort = {"updatedTime"},direction = Sort.Direction.DESC) Pageable pageable,
